...
export const metadata: Metadata = {
  title: "About | Oakland Khmer Angkor Dance Troupe",
  description:
    "Oakland Khmer Angkor Dance Troupe preserves Cambodian traditional dance through education, performance, and community programs in Oakland, California.",
};

export default function RootLayout() {
  return (
    <main className="font-light text-md animate-[fade-me-in_.5s_ease-in-out]">
      The Oakland Khmer Angkor Dance Troupe is dedicated to preserving and promoting the rich cultural heritage of Cambodian traditional dance. Through education, performance, and community engagement, we aim to inspire and empower youth, foster cross-cultural understanding, and celebrate the beauty of Khmer arts.
      <br /><br />
