        ...
        <div className="flex justify-center w-full p-5 pt-0 mb-10 pb-10 px-5 lg:px-10 animate-[fade-me-in_.5s_ease-in-out] bg-white">
          <div className="flex flex-col w-full max-w-[1040px] mt-[130px]">
            <div className="text-center">
              <div className="text-sm uppercase font-bold mb-2 text-[#F28904] tracking-widest">Impact</div>
            ...
            <div className="mt-5 border-[#F28904] py-[20px] flex flex-col lg:flex-row items-start">
              <div className="lg:w-1/2">
                ...
                <div id="answer1" className="font-light text-md">
                  ...
                  <br /><br />
                  Your support makes this work possible. It allows us to host performances, offer workshops, and engage with the community. Every contribution helps preserve Cambodian dance and pass it on to future generations.
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-center">
                ...
                <div className="col-span-2">
                  ...
                  <div id="answer3" className="font-light text-md">
                    Contributions support the essential needs of our troupe. This includes food for practice nights, props and decorations for authentic performances, compensation for youth dance teachers, costume purchase and care, and clean-up costs after events.
            ...
            <div className="border-[#F28904] py-[20px] flex flex-col lg:flex-row items-start">
              <div className="lg:w-2/3 pr-8">
                ...
                <div id="answer5" className="font-light text-md">
                  ...
                  <br /><br />
                  With your support, we can commission new costumes from skilled artisans and improve storage and care. This support strengthens Neary’s efforts and ensures future dancers perform in attire that honors our cultural heritage.
            ...
            <div className="border-[#F28904] py-[20px] flex flex-col lg:flex-row items-start">
              {/* <div className="lg:w-1/3 mt-6 lg:mt-0">
                <img src="/impact/umbrella.jpg" alt="Grantors and dancers at a partnership event" className="w-full rounded-lg shadow-md" />
              </div> */}
              <div className="">
                {/* <div id="question5" className="pb-6 font-serif text-2xl font-bold">
