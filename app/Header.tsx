              ...
              <nav className="hidden lg:flex items-center space-x-8">
                {navLinks.map((link) => (
                  <Link
                    key={link.href}
                    href={link.href}
                    className={`relative inline-block text-white text-[1.05rem] hover:text-[#F28904] hover:translate-x-1 transition-all duration-200 ease-out font-medium
            ...
            <nav className="space-y-6 mb-8">
              {navLinks.map((link) => (
                <Link
                  key={link.href}
                  href={link.href}
                  className={`block text-[1.25rem] font-medium transition-all duration-200 ease-out
                    ${isActiveLink(link.href)
                      ? 'text-[#F28904] border-l-4 border-[#F28904] pl-4'
                      : 'text-white hover:text-[#F28904] hover:translate-x-1 pl-4'
                    }
                  `}
                  onClick={() => setShowMenu(false)}
                >
